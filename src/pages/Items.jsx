...
export default function Items() {
  ...
  return (
    <>
      <div
        id="items"
        className="flex flex-col lg:flex-row justify-center lg:px-0 px-[16.1px] md:px-[25px] sm:px-[20px] sm:mt-0 mt-[1rem]"
      >
        <button
          onClick={handleFilterClick}
          className="flex flex-row filterBttn items-center bg-white rounded-lg gap-2 !w-[108px] justify-center hover:bg-[#f7f7f7] sm:hidden cursor-pointer"
        >
          <svg
        ...
        <div className="flex flex-row lg:mt-[5rem] sm:mt-[3rem] mt-[1rem]  contentContainer">
          <div className="hidden lg:flex flex-col items-center mr-auto">
            ...
            <div className="filterDiv ">
              ...
              <ul>
                <li
                  className={`flex flex-row items-center gap-2 category cursor-pointer ${
                ...
                <li
                  className={`flex flex-row items-center gap-2 category cursor-pointer ${
                    selectedCategory === "სარეცხი მანქანა"
                      ? "categoryActive"
                      : ""
                  }`}
          ...
          <div className="sellingItemContainer !w-[100%]">
            <div className="flex flex-row items-center">
              ...
              <div className="flex flex-row ml-auto relative gap-1">
                <button
                  onClick={handleFilterClick}
                  className="sm:flex flex-row filterBttn items-center bg-white rounded-lg gap-2 !w-[108px] justify-center hover:bg-[#f7f7f7] lg:hidden hidden cursor-pointer"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="mt-[2px]"
                ...
                >
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    style={{
                      transform: `rotate(${isOpenSort ? 270 : 90}deg)`,
                      transition: "transform 0.7s ease-in-out", // duration + easing
                    }}
                    width="1em"
                    height="1em"
                    fill="none"
              ...
              <div className="flex flex-row mr-auto justify-between items-center gap-2 pt-[5px] !text-[10.7px]">
                <div className="cursor-pointer">
                  <svg
                    ...
                    fill="none"
                    viewBox="0 0 10 10"
                    className="ml-1 sc-b65f0884-4 iYrBnu"
                  >
                    <path
                      stroke="#344054"
                      strokeLinecap="round"
