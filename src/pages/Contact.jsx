      ...
      <div id="contact" className="flex justify-center whiteWholeBG ">
        <div className="md:mt-[5rem] mt-[2rem]  contentContainer">
          <div id="contactUs" className="flex flex-col items-center">
            <div className="mr-auto">
              <p
                ...
                className="mb-[3rem] md:text-[31px] text-[22.5px]"
              >
                დაგვიკავშირდი
              </p>
            </div>
            ...
            <div
              className="flex flex-row justify-between justify-center gap-4"
              style={{ width: "100%" }}
            >
              <HorizontalScroll>
                <Link
                  ...
                  className="flex flex-col PercentCubeImageContainer flex-shrink-0 mr-auto"
                >
                  ...
                  <h2 className="boxHeading mt-[3px]">
                    ხიზანიშვილის 30, თბილისი
                  </h2>
                  <br />
                  <p className="boxText">
                    {" "}
                    გვესტუმრე 24 საათის განმავლობაში, კვირაში 7 დღე{" "}
                  </p>
                </Link>

                <Link
                  to="tel:+995555283839"
                  className="flex flex-col PercentCubeImageContainer flex-shrink-0"
                >
                  <div className="flex justify-center items-center percentIconContainer">
                    <h4 className="percentNum">
                      <svg
                ...
                <Link
                  to="mailto:infocshe@gmail.com"
                  className="flex flex-col PercentCubeImageContainer flex-shrink-0 ml-auto"
                >
                  <div className="flex justify-center items-center percentIconContainer">
                    <h4 className="percentNum">
                      <svg
                  ...
                  <br />
                  <p className="boxText">
                    მოგვწერე 24 საათის განმავლობაში, კვირაში 7 დღე{" "}
                  </p>
                </Link>
              </HorizontalScroll>
            </div>
          ...
          <div id="onGoogleMaps" className="mt-[5rem]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2974.6163703981365!2d44.816327!3d41.793480699999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40446c48575cb083%3A0x97e16635142c0d4b!2zMzAg4YOd4YOb4YOQ4YOgIOGDruGDmOGDluGDkOGDnOGDmOGDqOGDleGDmOGDmuGDmOGDoSDhg6Xhg6Phg6nhg5AsIOGDl-GDkeGDmOGDmuGDmOGDoeGDmCAwMTY3!5e0!3m2!1ska!2sge!4v1758023925082!5m2!1ska!2sge"
              width="100%"
              className="md:h-[600px] h-[295px]"
