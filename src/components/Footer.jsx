...
<div className="flex flex-col md:flex-row justify-between">
    <div className="flex flex-col">
        <Link to="/rules#services" className="flex flex-row items-center footerBoxHeading">მომსახურებები <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="17" height="14" fill="none" stroke="#141719" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="arrow-icon ml-auto flex md:hidden"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></Link>
