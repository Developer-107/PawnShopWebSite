...
export default function MainPageOtherServices() {
  ...
  return (
    ...
    <Link to="/rules#pawningItem" className="relative block lg:mr-auto overflow-hidden rounded-lg leaveItemContainer group w-[100%]">
  <img
    src={leaveItem}
  ...
  <div className="absolute bottom-4 left-4 text-[#f2f2f2] xl:text-[17.8px] md:text-[16.7px] font-semibold text-lg z-10">
    ...
    <Link to="/rules#buyingItems" className="relative block lg:mr-auto overflow-hidden rounded-lg leaveItemContainer group h-full lg:!h-[230px] w-[100%]">
    ...
    <Link to="/rules#sellingItem" className="relative block lg:mr-auto overflow-hidden rounded-lg leaveItemContainer group h-full lg:!h-[230px] w-full">
        <img className="leaveItem w-full h-full object-cover transition-transform duration-700 ease-in-out group-hover:scale-107" 
